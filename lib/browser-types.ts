...
declare namespace NodeJS {
  interface WritableStream {
    ...
    end(str: string, encoding?: any, cb?: () => void): void
  }
}
...
declare module 'buffer' {
  global {
    class Buffer extends Uint8Array {
      ...
      writeBigUInt64LE(value: number, offset: number): any
      writeBigUInt64BE(value: number, offset: number): any
      writeInt8(value: number, offset: number, noAssert?: boolean): number
      writeInt16LE(value: number, offset: number, noAssert?: boolean): number
      writeInt16BE(value: number, offset: number, noAssert?: boolean): number
      writeInt32LE(value: number, offset: number, noAssert?: boolean): number
      writeInt32BE(value: number, offset: number, noAssert?: boolean): number
      writeBigInt64LE(value: number, offset: number): any
      writeBigInt64BE(value: number, offset: number): any
...
declare module 'stream' {
  ...
  export type TransformCallback = any
  export const TransformCallback: any
